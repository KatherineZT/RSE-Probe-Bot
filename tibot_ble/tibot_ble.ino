...
// STARTUP SONG
int melody[] = {
  NOTE_CS5, 0, NOTE_CS5, NOTE_A4, NOTE_A5, 0, NOTE_CS5, NOTE_AS4, NOTE_E4, NOTE_CS5, NOTE_D5, NOTE_GS5
};
int noteDurations[] = {
  8, 8, 8, 16, 16, 16, 8, 16, 16, 8, 16, 8
};
...
void setup(void)
{
  ...
  Serial.println(F("******************************"));
  Serial.println(F("Controller is connected!"));
  Serial.println(F("******************************"));
